...
public class ChocoItemGroupArrays {
    ...
    private static @NotNull ArrayList<Item> chocoboGuiseGear() {
        ArrayList<Item> out = new ArrayList<>();
        out.add(CHAIN_CHOCO_DISGUISE_HELMET);
        out.add(CHAIN_CHOCO_DISGUISE_CHEST);
        out.add(CHAIN_CHOCO_DISGUISE_LEGS);
        out.add(CHAIN_CHOCO_DISGUISE_BOOTS);
        out.add(REINFORCED_CHAIN_CHOCO_DISGUISE_HELMET);
        out.add(REINFORCED_CHAIN_CHOCO_DISGUISE_CHEST);
        out.add(REINFORCED_CHAIN_CHOCO_DISGUISE_LEGS);
        out.add(REINFORCED_CHAIN_CHOCO_DISGUISE_BOOTS);
        ...
        out.add(REINFORCED_IRON_CHOCO_DISGUISE_HELMET);
        out.add(REINFORCED_IRON_CHOCO_DISGUISE_CHEST);
        out.add(REINFORCED_IRON_CHOCO_DISGUISE_LEGS);
        out.add(REINFORCED_IRON_CHOCO_DISGUISE_BOOTS);
        ...
        out.add(REINFORCED_DIAMOND_CHOCO_DISGUISE_HELMET);
        out.add(REINFORCED_DIAMOND_CHOCO_DISGUISE_CHEST);
        out.add(REINFORCED_DIAMOND_CHOCO_DISGUISE_LEGS);
        out.add(REINFORCED_DIAMOND_CHOCO_DISGUISE_BOOTS);
        ...
        out.add(REINFORCED_NETHERITE_CHOCO_DISGUISE_HELMET);
        out.add(REINFORCED_NETHERITE_CHOCO_DISGUISE_CHEST);
        out.add(REINFORCED_NETHERITE_CHOCO_DISGUISE_LEGS);
        out.add(REINFORCED_NETHERITE_CHOCO_DISGUISE_BOOTS);
        out.add(GILDED_NETHERITE_CHOCO_DISGUISE_HELMET);
        out.add(GILDED_NETHERITE_CHOCO_DISGUISE_CHEST);
        out.add(GILDED_NETHERITE_CHOCO_DISGUISE_LEGS);
        out.add(GILDED_NETHERITE_CHOCO_DISGUISE_BOOTS);
        return out;
    }
