...
public class chocoKB {
    ...
    public static boolean isChocoboWaterGlide() { if (isKeyBindDefault(L_ALT)) { return (RAlt() || LAlt()); } else { return LAlt(); } }
    public static boolean isChocoShiftDown() { if (isKeyBindDefault(L_SHIFT)) { return (ChocoLShift() || ChocoRShift()); } else  { return ChocoLShift(); } }
