...
public class gysahlGreenBiomes {
    ...
    public static int getBiomeID(RegistryKey<Biome> biomeRegistryKey) {
        int privateBiome = 1; //
        if (GoldenGysahlBiomes().contains(biomeRegistryKey)) { privateBiome = 2; }
        if (PinkGreenBiomes().contains(biomeRegistryKey)) { privateBiome = 3; }
        if (DeadGreenBiomes().contains(biomeRegistryKey)) { privateBiome = 4; }
        if (SpikeGreenBiomes().contains(biomeRegistryKey)) { privateBiome = 5; }
        if (LovelyGreenBiomes().contains(biomeRegistryKey)) { privateBiome = 6; }
        return privateBiome;
    }
    ...
    public static int getGreenCount() { return 6; } //  default empty
}