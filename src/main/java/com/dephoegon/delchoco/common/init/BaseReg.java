...
public class BaseReg {
    ...
    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(DelChoco.DELCHOCO_ID, name), new BlockItem(block, new FabricItemSettings()));
    }
    ...
    protected static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(DelChoco.DELCHOCO_ID, name), item);
    }
}