...
public class ModEntities {
    ...
    public static final EntityType<ArmorStand> CHOCOBO_ARMOR_STAND_ENTITY = Registry.register(Registries.ENTITY_TYPE, new Identifier(DelChoco.DELCHOCO_ID, "chocobo_armor_stand"), FabricEntityTypeBuilder.create(SpawnGroup.MISC, ArmorStand::new).dimensions(EntityDimensions.fixed(1.2f, 2.8f)).trackRangeChunks(4).trackedUpdateRate(Integer.MAX_VALUE).fireImmune().disableSummon().build());
    /*
    ...
    */
    ...
    public static void registerAttributes() {
        ...
        FabricDefaultAttributeRegistry.register(CHOCOBO_ARMOR_STAND_ENTITY, Chocobo.createAttributes());
