...
public class ModItems extends BaseReg {
    ...
    public static final Item GOLDEN_GYSAHL_GREEN = registerItem("golden_gysahl_green", new Item(new FabricItemSettings().group(DelChoco.DELCHOCO_ITEMS).maxCount(64)));
    ...
    public static final Item FLAME_CHOCOBO_SPAWN_EGG = registerItem("flame_chocobo_spawn_egg", new ChocoboSpawnEggItem(new FabricItemSettings().group(DelChoco.DELCHOCO_ITEMS).maxCount(64), ChocoboColor.FLAME));
