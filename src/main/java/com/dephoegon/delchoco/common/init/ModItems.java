...
public class ModItems extends BaseReg {
    ...
    public static final Item CHAIN_CHOCO_CHEST = registerItem("chocobo_armor_chain", new ChocoboArmorItems(CHOCOBO_ARMOR_MATERIALS.get(1), EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1)));
    public static final Item IRON_CHOCO_CHEST = registerItem("chocobo_armor_iron", new ChocoboArmorItems(CHOCOBO_ARMOR_MATERIALS.get(2), EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1)));
    public static final Item DIAMOND_CHOCO_CHEST = registerItem("chocobo_armor_diamond", new ChocoboArmorItems(CHOCOBO_ARMOR_MATERIALS.get(3), EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1)));
    public static final Item NETHERITE_CHOCO_CHEST = registerItem("chocobo_armor_netherite", new ChocoboArmorItems(CHOCOBO_ARMOR_MATERIALS.get(4), EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1).fireproof()));
    ...
    // ChocoGuise Gear
    public static final Item LEATHER_CHOCO_DISGUISE_HELMET = registerItem("choco_disguise_leather_helmet", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(1), EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1)));
    public static final Item LEATHER_CHOCO_DISGUISE_CHEST = registerItem("choco_disguise_leather_chestplate", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(1), EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1)));
    public static final Item LEATHER_CHOCO_DISGUISE_LEGS = registerItem("choco_disguise_leather_leggings", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(1), EquipmentSlot.LEGS, new FabricItemSettings().maxCount(1)));
    public static final Item LEATHER_CHOCO_DISGUISE_BOOTS = registerItem("choco_disguise_leather_boots", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(1), EquipmentSlot.FEET, new FabricItemSettings().maxCount(1)));
    public static final Item IRON_CHOCO_DISGUISE_HELMET = registerItem("choco_disguise_iron_helmet", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(2), EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1)));
    public static final Item IRON_CHOCO_DISGUISE_CHEST = registerItem("choco_disguise_iron_chestplate", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(2), EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1)));
    public static final Item IRON_CHOCO_DISGUISE_LEGS = registerItem("choco_disguise_iron_leggings", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(2), EquipmentSlot.LEGS, new FabricItemSettings().maxCount(1)));
    public static final Item IRON_CHOCO_DISGUISE_BOOTS = registerItem("choco_disguise_iron_boots", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(2), EquipmentSlot.FEET, new FabricItemSettings().maxCount(1)));
    public static final Item DIAMOND_CHOCO_DISGUISE_HELMET = registerItem("choco_disguise_diamond_helmet", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(3), EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1)));
    public static final Item DIAMOND_CHOCO_DISGUISE_CHEST = registerItem("choco_disguise_diamond_chestplate", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(3), EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1)));
    public static final Item DIAMOND_CHOCO_DISGUISE_LEGS = registerItem("choco_disguise_diamond_leggings", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(3), EquipmentSlot.LEGS, new FabricItemSettings().maxCount(1)));
    public static final Item DIAMOND_CHOCO_DISGUISE_BOOTS = registerItem("choco_disguise_diamond_boots", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(3), EquipmentSlot.FEET, new FabricItemSettings().maxCount(1)));
    public static final Item NETHERITE_CHOCO_DISGUISE_HELMET = registerItem("choco_disguise_netherite_helmet", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(4), EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1)));
    public static final Item NETHERITE_CHOCO_DISGUISE_CHEST = registerItem("choco_disguise_netherite_chestplate", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(4), EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1)));
    public static final Item NETHERITE_CHOCO_DISGUISE_LEGS = registerItem("choco_disguise_netherite_leggings", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(4), EquipmentSlot.LEGS, new FabricItemSettings().maxCount(1)));
    public static final Item NETHERITE_CHOCO_DISGUISE_BOOTS = registerItem("choco_disguise_netherite_boots", new ChocoDisguiseItem(CHOCO_ARMOR_MATERIALS.get(4), EquipmentSlot.FEET, new FabricItemSettings().maxCount(1)));
