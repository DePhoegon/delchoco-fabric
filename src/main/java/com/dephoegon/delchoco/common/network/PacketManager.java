...
public class PacketManager {
    public static final Identifier OPEN_CHOCOBO_GUI_PACKET_ID = new Identifier(DelChoco.Mod_ID, "open_chocobo_gui");
    public static final Identifier CHOCOBO_SPRINTING_PACKET_ID = new Identifier(DelChoco.Mod_ID, "chocobo_sprinting");
